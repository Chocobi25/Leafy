...
public enum TripError implements ErrorCode {
    ...
    STALE_TRIP_ROUTE_CANDIDATE(HttpStatus.BAD_REQUEST, "여행 장소가 변경되어 경로를 다시 계산해야 합니다."),
    INVALID_TRIP_TRANSPORT(HttpStatus.BAD_REQUEST, "여행 교통수단 정보가 올바르지 않습니다."),
    INVALID_TRIP_ROUTE_CANDIDATE(HttpStatus.BAD_REQUEST, "여행 경로 후보 요청 정보가 올바르지 않습니다."),
    ...
    TRIP_NOT_EDITABLE(HttpStatus.BAD_REQUEST, "진행 중이거나 완료된 여행은 수정할 수 없습니다."),
