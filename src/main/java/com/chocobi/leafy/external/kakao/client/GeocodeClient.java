package com.chocobi.leafy.external.kakao.client;

import com.chocobi.leafy.external.kakao.dto.GeocodeResponse;
import com.chocobi.leafy.external.kakao.dto.GeocodeResponse.Address;
import com.chocobi.leafy.external.kakao.dto.GeocodeResponse.Document;
...
public class GeocodeClient {
    ...
    public GeocodedAddress getCoordinatesFromAddress(String address) {
    ...
    private GeocodedAddress extractCoordinatesAndAddress(GeocodeResponse response) {
        ...
        try {
            ...
            return new GeocodedAddress(y, x, address);
        } catch (NumberFormatException e) {
            return defaultResult();
        }
    }

    private GeocodedAddress defaultResult() {
